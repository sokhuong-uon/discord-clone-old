    ...
    <div class="w-full bg-gray-800 block">
        ...
        <div class="w-full h-12 border-b px-2 flex items-center border-gray-900  bg-nightgraylighter">
			...
			<div class="w-auto h-6 text-gray-500 flex-shrink-0 flex items-center justify-between overflow-hidden">
				...
				<svg class="w-6 h-6 mx-2" aria-hidden="false" fill="none"><path d="M19 3H4.99c-1.11 0-1.98.89-1.98 2L3 19c0 1.1.88 2 1.99 2H19c1.1 0 2-.9 2-2V5a2 2 0 00-2-2zm0 12h-4c0 1.66-1.35 3-3 3s-3-1.34-3-3H4.99V5H19v10z" fill="currentColor"/></svg>

				<svg class="w-6 h-6 mx-2" aria-hidden="false"><path fill="currentColor" d="M12 2C6.486 2 2 6.487 2 12c0 5.515 4.486 10 10 10s10-4.485 10-10c0-5.513-4.486-10-10-10zm0 16.25a1.25 1.25 0 110-2.5 1.25 1.25 0 010 2.5zm1-4.375V15h-2v-3h1a2 2 0 10-2-2H8c0-2.205 1.795-4 4-4s4 1.795 4 4a4.01 4.01 0 01-3 3.875z"/></svg>
			</div>
		</div>
        ...
        return {
            ...
            servers: [{
                ...
                },
                {
                    ...
                    imageUrl: "https://cdn.discordapp.com/icons/508357248330760243/e6ca01fc39a99cc2172b65249f0c101f.png?size=256",
                    gifUrl: "",
                    hasUnReadMessage: 13
                },
                {
