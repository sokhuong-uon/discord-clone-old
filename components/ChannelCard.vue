...
<div @mouseover="isHover = true" @mouseleave="isHover = false" class="w-58 my-px h-8 flex justify-center">
    ...
    <div :class="{'bg-gray-800':isHover, 'bg-gray-800':this.$store.state.currentChannel.channelName==this.channel.name, 'text-gray-600':channel.hasUnReadMessage === 0, 'text-green-500':channel.hasUnReadMessage > 0}" class="w-56 px-2 rounded-lg cursor-pointer flex items-center">
